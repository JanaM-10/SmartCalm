...
- Retrain the final deployed model on the full dataset (real + synthetic) rather than the best single LOSO fold
- Package feature extraction as a shared module between training notebooks and the backend's `feature_extractor.py` to avoid logic duplication
