...
class _HighScreenState extends State<HighScreen> {
  ...
  static const _alertRed = Color(0xFFB24040);
            ...
            text: TextSpan(
              ...
              children: [
                ...
                WidgetSpan(
                  ...
                  child: _CalmBrandAccent(titleStyle: titleStyle),
                ),
              ],
            ),
          ),
...
class _CalmBrandAccent extends StatelessWidget {
  const _CalmBrandAccent({required this.titleStyle});
  ...
  Widget build(BuildContext context) {
    return IntrinsicWidth(
      child: Column(
        ...
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          Text('Calm', style: titleStyle.copyWith(color: _coral)),
...
class _ConnectionCard extends StatelessWidget {
  ...
  static const _navy = Color(0xFF1A2744);
  static const _coral = Color(0xFFE8647A);
  static const _connectionBg = Color(0xFFFFF0F3);
  static const _fontFamily = 'DM Sans';
          ...
          children: [
            Padding(
              ...
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: const [
                  Icon(Icons.check_circle_rounded, color: _coral, size: 24),
                  SizedBox(width: 8),
                  Text(
                    'Connected',
                    style: TextStyle(
            ...
            Container(width: 1, color: _navy.withValues(alpha: 0.15)),
            Expanded(
              child: Padding(
...
class _SensorCard extends StatelessWidget {
  ...
  static const _iconCircleBg = Color(0xFFFFE4EA);
  static const _fontFamily = 'DM Sans';
